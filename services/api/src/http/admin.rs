...
// Generated by `npm run admin:build` from the authored React application in
// `apps/admin`. Embedding keeps the hosted deployment as one Rust service.
const HTML: &str = include_str!("../../admin-dist/index.html");
const CSS: &str = include_str!("../../admin-dist/assets/admin.css");
const JS: &str = include_str!("../../admin-dist/assets/admin.js");
const ICON: &str = include_str!("../../admin-dist/assets/favicon.svg");
